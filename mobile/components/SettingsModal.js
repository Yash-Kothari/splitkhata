    ...
    <Modal visible={visible} animationType="slide" onRequestClose={onClose}>
      <View className="flex-1 bg-paper">
        ...
        <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
          ...
          {activeTab === 'budgets' && (
            <View>
              <Text className="font-display text-base font-bold text-ink mb-0.5">Household Category Budgets</Text>
          ...
          {activeTab === 'recurring' && (
            <View>
              <Text className="font-display text-base font-bold text-ink mb-0.5">Recurring Household Expenses</Text>
              <Text className="font-body text-xs text-muted-text mb-3">
          ...
          {activeTab === 'reminders' && (
            <View>
              <Text className="font-display text-base font-bold text-ink mb-0.5">Payment Reminders</Text>
              <Text className="font-body text-xs text-muted-text mb-3">
          ...
          {activeTab === 'cards' && (
            <View>
              <Text className="font-display text-base font-bold text-ink mb-0.5">Credit Cards</Text>
              <Text className="font-body text-xs text-muted-text mb-3">
          ...
          {activeTab === 'currencies' && (
            <View>
              <Text className="font-display text-base font-bold text-ink mb-0.5">Manage Currencies</Text>
          ...
          {activeTab === 'members' && (
            <View>
              <Text className="font-display text-base font-bold text-ink mb-0.5">Manage Members</Text>
          ...
          {activeTab === 'security' && (
            <View>
              <Text className="font-display text-base font-bold text-ink mb-0.5">App Passcode & Security PIN</Text>
              <Text className="font-body text-xs text-muted-text mb-3">
                ...
                <View className="pt-3 border-t border-ink/10">
                  ...
                  <View className="flex-row gap-2">
                    <TextInput
                      ...
                      secureTextEntry
                      maxLength={4}
                      className="flex-1 font-mono text-base font-bold text-ink border border-ink/15 rounded-xl px-3.5 py-2.5 bg-paper tracking-widest"
                    />
